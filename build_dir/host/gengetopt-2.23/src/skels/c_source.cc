...
c_source_gen_class::generate_c_source(ostream &stream, unsigned int indent)
{
  ...
  generate_string (args_info, stream, indent + indent_str.length ());
  stream << "_versiontext = \"";
  generate_string (versiontext, stream, indent + indent_str.length ());
  stream << "\";";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  ...
  stream << "\n";
  stream << indent_str;
  stream << "	size_t len_purpose = strlen(";
  generate_string (args_info, stream, indent + indent_str.length ());
  stream << "_purpose);";
  stream << "\n";
  stream << indent_str;
  stream << "	size_t len_usage = strlen(";
  generate_string (args_info, stream, indent + indent_str.length ());
  stream << "_usage);";
  stream << "\n";
  stream << indent_str;
  ...
  stream << "\n";
  stream << indent_str;
  stream << "	if (len_usage || len_purpose) {";
  stream << "\n";
  stream << indent_str;
  stream << "		printf(\"\\n\");";
  stream << "\n";
  ...
  if (( ! no_options ))
    {
      ...
      if (( ( ( ( ( ( has_arg_int || has_arg_short ) || has_arg_long ) || has_arg_float ) || has_arg_double ) || has_arg_longdouble ) || has_arg_longlong ))
      ...
      else
        {
          ...
          stream << indent_str;
          stream << "	";
          if (( ! ( has_arg_enum || has_arg_string ) ))
            {
  ...
  stream << "\n";
  stream << indent_str;
  stream << "  /* TODO: Why is this here? It is not used anywhere. */";
  stream << "\n";
  stream << indent_str;
  stream << "  override = params->override;";
  stream << "\n";
  stream << indent_str;
  stream << "  FIX_UNUSED(override);";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
  ...
  stream << "\n";
  stream << indent_str;
  stream << "  FIX_UNUSED(check_ambiguity);";
  stream << "\n";
  stream << indent_str;
  stream << "\n";
  stream << indent_str;
  ...
  stream << "/* vim: set ft=c noet ts=8 sts=8 sw=8 tw=80 nojs spell : */";
  stream << "\n";
  stream << indent_str;
}
