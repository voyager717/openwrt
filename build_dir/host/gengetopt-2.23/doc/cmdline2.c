/*
  ...
  ../src/gengetopt -Fcmdline2 --func-name=my_cmdline_parser -u --no-handle-help --no-handle-version -i ../../doc/sample2.ggo 
...
const char *gengetopt_args_info_usage = "Usage: " MY_CMDLINE_PARSER_PACKAGE " [OPTION]... [FILE]...";
