...
main (int argc, char **argv)
{
  ...
  if (test_manual_help_args_cmd_parser (argc, argv, &args_info) != 0) {
    result = 1;
    goto end;
  }

  if (args_info.detailed_help_given)
    test_manual_help_args_cmd_parser_print_detailed_help();

  if (args_info.version_given)
    test_manual_help_args_cmd_parser_print_version();
  ...
  if (args_info.help_given && !help_printed)
    test_manual_help_args_cmd_parser_print_help();
