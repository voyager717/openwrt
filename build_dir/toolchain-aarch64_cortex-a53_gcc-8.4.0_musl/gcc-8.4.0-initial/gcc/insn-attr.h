...
#define HAVE_ATTR_fp16 1
extern enum attr_fp16 get_attr_fp16 (rtx_insn *);

#define HAVE_ATTR_simd 1
extern enum attr_simd get_attr_simd (rtx_insn *);

#define HAVE_ATTR_sve 1
extern enum attr_sve get_attr_sve (rtx_insn *);
