...
enum {
    WPA3_FRAME_BEACON=1,
    WPA3_FRAME_EAPOL_M3,
    WPA3_FRAME_SA_QUERY_REQ,
    WPA3_FRAME_CHANNEL_SWITCH_ANNOUNCEMENT,
    WPA3_FRAME_REASSOC_REQ,
    WPA3_FRAME_ANQP_QUERY,
};

typedef struct wpa3_frame
{
    BYTE eFrameName;
    char sDestMac[WFA_MAC_ADDR_STR_LEN];
    char sInterface[WFA_IF_NAME_LEN];
    int ChnlFreq;
} wpa3Frame_t;
