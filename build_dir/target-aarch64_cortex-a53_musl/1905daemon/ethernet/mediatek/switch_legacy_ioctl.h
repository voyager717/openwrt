...
/*
 * switch_legacy_ioctl.h, it's used for <<switch 7530 + raeth driver>>
 *
 * Author: Sirui Zhao <Sirui.Zhao@mediatek.com>
 */
#ifndef _SWITCH_LEGACY_IOCTL_H
#define _SWITCH_LEGACY_IOCTL_H
...
static int reg_read_ioctl(int offset, int *value) { return -1;}
static int reg_write_ioctl(int offset, int value) { return -1;}
#else
