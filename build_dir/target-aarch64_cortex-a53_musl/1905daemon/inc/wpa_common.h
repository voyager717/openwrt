...
#define RSN_MULTI_AP_GTK_KDE RSN_SELECTOR(0x50, 0x6f, 0x9a, 0)
#if 0
...
extern int dev_send_eapol(void *ctx, unsigned char *dst_almac, unsigned char *eapol_frame, unsigned short eapol_len);
extern int sec_set_key(unsigned char *almac, unsigned char *key, size_t key_len, 
