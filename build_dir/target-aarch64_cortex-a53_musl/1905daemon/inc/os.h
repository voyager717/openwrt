...
extern char mapd_trace_fail_func[256];
extern unsigned int mapd_trace_fail_after;
extern char mapd_trace_test_fail_func[256];
extern unsigned int mapd_trace_test_fail_after;
#else
#define TEST_FAIL() 0
#endif
...
/*start by system up. do not effect by time update by internet*/
static inline int os_get_time(struct os_time *t)
{
	...
	//printf("os_get_time CLOCK_MONOTONIC: %lu, %lu\n", t->sec, t->usec);
