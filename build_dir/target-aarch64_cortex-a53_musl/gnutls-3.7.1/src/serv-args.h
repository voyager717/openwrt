...
typedef enum {
    ...
    INDEX_OPT_UDP                          = 15,
    INDEX_OPT_MTU                          = 16,
    INDEX_OPT_SRTP_PROFILES                = 17,
    INDEX_OPT_DISABLE_CLIENT_CERT          = 18,
    INDEX_OPT_REQUIRE_CLIENT_CERT          = 19,
    INDEX_OPT_VERIFY_CLIENT_CERT           = 20,
    INDEX_OPT_HEARTBEAT                    = 21,
    INDEX_OPT_X509FMTDER                   = 22,
    INDEX_OPT_PRIORITY                     = 23,
    INDEX_OPT_DHPARAMS                     = 24,
    INDEX_OPT_X509CAFILE                   = 25,
    INDEX_OPT_X509CRLFILE                  = 26,
    INDEX_OPT_PGPKEYFILE                   = 27,
    INDEX_OPT_X509KEYFILE                  = 28,
    INDEX_OPT_X509CERTFILE                 = 29,
    INDEX_OPT_X509DSAKEYFILE               = 30,
    INDEX_OPT_X509DSACERTFILE              = 31,
    INDEX_OPT_X509ECCKEYFILE               = 32,
    INDEX_OPT_X509ECCCERTFILE              = 33,
    INDEX_OPT_RAWPKKEYFILE                 = 34,
    INDEX_OPT_RAWPKFILE                    = 35,
    INDEX_OPT_SRPPASSWD                    = 36,
    INDEX_OPT_SRPPASSWDCONF                = 37,
    INDEX_OPT_PSKPASSWD                    = 38,
    INDEX_OPT_PSKHINT                      = 39,
    INDEX_OPT_OCSP_RESPONSE                = 40,
    INDEX_OPT_IGNORE_OCSP_RESPONSE_ERRORS  = 41,
    INDEX_OPT_PORT                         = 42,
    INDEX_OPT_LIST                         = 43,
    INDEX_OPT_PROVIDER                     = 44,
    INDEX_OPT_KEYMATEXPORT                 = 45,
    INDEX_OPT_KEYMATEXPORTSIZE             = 46,
    INDEX_OPT_RECORDSIZE                   = 47,
    INDEX_OPT_HTTPDATA                     = 48,
...
#define OPTION_CT    52
/** gnutls-serv version */
#define GNUTLS_SERV_VERSION       "3.7.1"
/** Full gnutls-serv version text */
#define GNUTLS_SERV_FULL_VERSION  "gnutls-serv 3.7.1"
...
#define VALUE_OPT_X509DSAKEYFILE 0x1018
#define VALUE_OPT_X509DSACERTFILE 0x1019
#define VALUE_OPT_X509ECCKEYFILE 0x101A
#define VALUE_OPT_X509ECCCERTFILE 0x101B
#define VALUE_OPT_RAWPKKEYFILE   0x101C
#define VALUE_OPT_RAWPKFILE      0x101D
#define VALUE_OPT_SRPPASSWD      0x101E
#define VALUE_OPT_SRPPASSWDCONF  0x101F
#define VALUE_OPT_PSKPASSWD      0x1020
#define VALUE_OPT_PSKHINT        0x1021
#define VALUE_OPT_OCSP_RESPONSE  0x1022
#define VALUE_OPT_IGNORE_OCSP_RESPONSE_ERRORS 0x1023
#define VALUE_OPT_PORT           'p'

#define OPT_VALUE_PORT           (DESC(PORT).optArg.argInt)
#define VALUE_OPT_LIST           'l'
#define VALUE_OPT_PROVIDER       0x1024
#define VALUE_OPT_KEYMATEXPORT   0x1025
#define VALUE_OPT_KEYMATEXPORTSIZE 0x1026
...
#define VALUE_OPT_HTTPDATA       0x1028
