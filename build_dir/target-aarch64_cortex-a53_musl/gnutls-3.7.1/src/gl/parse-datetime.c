...
#line 1977 "parse-datetime.c"
  ...
  case 28:
#line 731 "parse-datetime.y"
      { pc->local_isdst = (yyvsp[0].intval); }
#line 1983 "parse-datetime.c"
    break;

  case 29:
#line 733 "parse-datetime.y"
      {
        pc->local_isdst = 1;
        pc->dsts_seen++;
      }
#line 1992 "parse-datetime.c"
    break;
...
#line 2035 "parse-datetime.c"
  ...
  case 36:
#line 762 "parse-datetime.y"
      { pc->time_zone = (yyvsp[-1].intval) + 60 * 60; }
#line 2041 "parse-datetime.c"
    break;

  case 37:
#line 767 "parse-datetime.y"
      {
        pc->day_ordinal = 0;
        pc->day_number = (yyvsp[0].intval);
      }
#line 2050 "parse-datetime.c"
    break;
...
#line 2079 "parse-datetime.c"
    break;

  case 41:
#line 792 "parse-datetime.y"
      {
...
#line 2388 "parse-datetime.c"
  ...
  case 87:
#line 968 "parse-datetime.y"
      { if (time_overflow ((yyvsp[0].textintval).value)) YYABORT;
        (yyval.timespec).tv_sec = (yyvsp[0].textintval).value; (yyval.timespec).tv_nsec = 0; }
#line 2395 "parse-datetime.c"
    break;
