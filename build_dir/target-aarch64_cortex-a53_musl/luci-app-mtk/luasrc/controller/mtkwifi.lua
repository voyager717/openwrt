...
function index()
	...
	--[[ 2023-12-08: zzk
    entry({"admin", "mtk"}, firstchild(), _("WIFI"), 80)
    entry({"admin", "mtk", "test"}, call("test"))
    entry({"admin", "mtk", "wifi"}, template("admin_mtk/mtk_wifi_overview"), _("WiFi configuration"), 12)
    entry({"admin", "mtk", "wifi", "chip_cfg_view"}, template("admin_mtk/mtk_wifi_chip_cfg")).leaf = true
    --]]
    entry({"admin", "network", "wifi"}, template("admin_mtk/mtk_wifi_overview"), _("WiFi configuration"), 13)
    entry({"admin", "mtk", "wifi", "chip_cfg_view"}, template("admin_mtk/mtk_wifi_chip_cfg")).leaf = true
    ...
    entry({"admin", "system", "console"}, template("admin_mtk/mtk_web_console"), _("Web Console"), 4)
...
--[[ 2023-07-04: zzk
    if map_help then
        ...
        entry({"admin", "network", "multi_ap", "reset_to_default_easymesh"}, call("reset_to_default_easymesh")).leaf = true;
        entry({"admin", "network", "multi_ap"}, template("admin_mtk/mtk_wifi_multi_ap"), _("EasyMesh"), 13);
