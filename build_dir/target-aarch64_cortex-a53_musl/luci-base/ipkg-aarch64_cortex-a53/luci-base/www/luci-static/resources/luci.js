...
LuCI.prototype.error('Status Data updating','Argument must be a class instance');return this.data(node,'_class',inst);},findClassInstance:function(node){var inst=null;do{inst=this.data(node,'_class');node=node.parentNode;}
...
LuCI.prototype.error('Status Data updating','"%s" factory yields invalid constructor',name);if(_class.displayName=='AnonymousClass')
