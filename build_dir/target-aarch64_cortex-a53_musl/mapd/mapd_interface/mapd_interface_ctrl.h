...
struct GNU_PACKED client_db {
	...
	unsigned char know_channels[MAX_CHAN_BITMAP];
};

struct mapd_inteface_skip_channel_list {
       unsigned char AutoChannelSkipListNum;
       unsigned char AutoChannelSkipList[60];
       unsigned char preferredListNum;
       unsigned char preferredList[60];
};

int mapd_interface_get_skip_list(struct mapd_interface_ctrl *ctrl,
 ...
 *
 *
 * set the user defined restricted steer list of BSSid.
 */
